...
Please follow the [Wiki](https://github.com/muditha-silva/DropWizard-AWS-Elastic-BeanStalk/wiki) which gives a step by step AWS configuration and deployment steps.  
...
This application is going to be deployed in a `public subnet` which resides in a `private VPC`, this utilize a `MySql RDS instance` deployed in a `private subnet` which reside in a `private VPC`.  
...
Step by step AWS Elastic beanstalk deployemnt explains in the [Wiki ELB Deployment Section](https://github.com/muditha-silva/DropWizard-AWS-Elastic-BeanStalk/wiki/Deploy-the-Docker-image-using-AWS-Elastic-BeanStalk.).
